...
df_jp_ind = pd.read_csv("../analysis_jp_wage/csvdata/雇用_医療福祉_一人当たり賃金_全国_全産業.csv",encoding="shift-jis")
df_jp_category = pd.read_csv("../analysis_jp_wage/csvdata/雇用_医療福祉_一人当たり賃金_全国_大分類.csv",encoding='shift-jis')
df_pref_ind = pd.read_csv("../analysis_jp_wage/csvdata/雇用_医療福祉_一人当たり賃金_都道府県_全産業.csv",encoding='shift-jis')
